...
static RoleSpec *makeRoleSpec(int type, int location);
...
static void insertSelectOptions(SelectStmt *stmt,
								...
								core_yyscan_t yyscanner);
static Node *makeSetOp(int op, bool all, Node *larg, Node *rarg);
...
static Node *makeSQLValueFunction(int op, int32 typmod, int location);
static Node *makeXmlExpr(int op, char *name, List *named_args,
...
static int parsePartitionStrategy(char *strategy, int location,
												core_yyscan_t yyscanner);
